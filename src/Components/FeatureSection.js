    ...
    return (
        <div className='mt-16'>
            <div className="relative container mx-auto">
                <div className="bg-[#0cbe8c] w-36 h-36 absolute z-0 top-20 left-0 rounded-2xl"></div>
                <div className="p-4 md:p-6 relative z-10">
                    <div className="flex flex-col rounded-xl container mx-auto px-4 bg-white md:p-20 py-6">
                        <div className="text-left space-y-8">
                            <h1 className="text-4xl md:text-5xl font-bold text-[#0cbe8c]">
                                Features you need
                            </h1>
                            <p className="text-[#a7a7a7] font-medium text-lg md:w-1/2">
